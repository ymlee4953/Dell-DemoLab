...
4. List NIM profiles
    ...
    ```
    Sample Output: <br>
    ![image]([https://github.com/ymlee4953/Dell-DemoLab/tree/main/DemoRoom/NVIDIA GenAI Workshop/images/lab1-list-model-profiles.png](https://github.com/ymlee4953/Dell-DemoLab/blob/main/DemoRoom/NVIDIA%20GenAI%20Workshop/images/lab1-list-model-profiles.png))
